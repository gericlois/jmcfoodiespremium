...
$admins = $conn->query("SELECT id, name FROM admins ORDER BY name ASC");
$admin_list = [];
...
$sql = "SELECT * FROM activity_log WHERE admin_type = 'wellness'";
if ($admin_filter > 0) {
...
<div class="container-fluid py-4">
  ...
  <p class="text-muted small mb-3">Showing the most recent 300 Wellness admin entries.</p>
