...
$sql = "SELECT bm.*, u.full_name, u.username FROM basics_members bm
        JOIN users u ON u.id = bm.user_id WHERE bm.application_status = 'approved'";
...
<div class="container-fluid py-4">
  ...
  <div class="table-responsive">
    <table class="table-theme">
      <thead><tr><th>Member</th><th>Weekly Limit</th><th>Offenses</th><th>On-Time Streak</th><th>Status</th><th></th></tr></thead>
      <tbody>
      ...
      <?php while ($m = $members->fetch_assoc()): ?>
        <tr>
          ...
          <td><a href="<?= BASE_URL ?>/basics/admin/member_view.php?id=<?= (int) $m['id'] ?>" class="btn-chip btn-chip-outline">View</a></td>
        </tr>
      <?php endwhile; ?>
      </tbody>
    </table>
