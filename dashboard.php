...
<div class="container py-5">
  <div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
      <div class="stat-tile">
        ...
        <div class="stat-lbl">Personal Rebates Earned</div>
      </div>
    </div>
    <div class="col-6 col-md-3">
      <div class="stat-tile">
        <div class="stat-num"><?= format_price($total_overrides) ?></div>
        <div class="stat-lbl">Referral Overrides Earned</div>
      </div>
    </div>
    <div class="col-6 col-md-3">
      <div class="stat-tile">
        <div class="stat-num"><?= (int) $referrals->num_rows ?></div>
        <div class="stat-lbl">Direct Referrals</div>
      </div>
    </div>
    <div class="col-6 col-md-3">
      <div class="stat-tile">
  ...
  <div class="panel-card mb-4">
    <h2 class="h6 mb-3">Your Referral Code &amp; Link</h2>
  ...
  <h2 class="h5 mb-3">Your Direct Referrals</h2>
