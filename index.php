    ...
    <div class="row align-items-center g-5" style="min-height:78vh;">
      <div class="col-lg-7 mx-auto text-center">
        ...
        <p class="hdesc mx-auto">
          ...
          you personally invite &mdash; one level, no complicated downlines.
        </p>
        <div class="d-flex flex-wrap justify-content-center gap-3 mb-2">
          <?php if (is_logged_in()): ?>
            <a href="<?= BASE_URL ?>/dashboard.php" class="btn-red"><i class="fas fa-gauge-high"></i>Go to Dashboard</a>
          <?php else: ?>
...
<section id="product" class="shop-bg">
  <div class="container">
        ...
        <div class="col-6 col-md-3">
          <div class="panel-card h-100 d-flex flex-column p-0 overflow-hidden text-center">
            ...
            <div class="p-4 d-flex flex-column flex-grow-1">
              ...
              <div class="mt-auto">
                <a href="<?= BASE_URL ?>/product.php?id=<?= (int) $product['id'] ?>" class="btn-red justify-content-center w-100"><i class="fas fa-eye"></i>View Product</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="text-center mt-5">
      <a href="<?= BASE_URL ?>/menu.php" class="btn-outline-theme"><i class="fas fa-store"></i>View Full Shop</a>
    </div>
  </div>
</section>
<?php endif; ?>
