    ...
    <div class="sucmsg is-visible">
      <p>
        <?php if (isset($_GET['pending'])): ?>
          Order placed! It's awaiting admin confirmation of your GCash payment, then delivery, before your rebate is credited.
        <?php else: ?>
  ...
  <div class="table-responsive">
    <table class="table-theme">
      ...
      <?php if ($orders->num_rows === 0): ?>
        <tr><td colspan="7" class="text-muted">You haven't placed any orders yet. <a href="<?= BASE_URL ?>/buy.php">Buy now</a>.</td></tr>
      <?php endif; ?>
      <?php while ($order = $orders->fetch_assoc()): ?>
        <tr>
          ...
          <td class="text-capitalize"><?= sanitize($order['payment_method']) ?></td>
