...
<div class="container pt-4">
  <nav aria-label="breadcrumb" class="small">
    <a href="<?= WELLNESS_URL ?>/menu.php" class="text-decoration-none">Shop</a>
  ...
  <div class="row g-5 align-items-start">
    ...
    <div class="col-lg-7">
      ...
      <div class="d-flex flex-wrap gap-3 mb-4">
        <?php if (is_logged_in()): ?>
          <a href="<?= WELLNESS_URL ?>/buy.php?product=<?= (int) $product['id'] ?>" class="btn-red"><i class="fas fa-bag-shopping"></i>Buy Now</a>
        <?php else: ?>
